...
all-rules-matched = Alle der folgenden Regeln treffen gemeinsam zu:
any-rules-matched = Eine oder mehr der folgenden Regeln trifft zu:
profile-activation-desc = Aktiviere Profil '{ $name }' falls:
