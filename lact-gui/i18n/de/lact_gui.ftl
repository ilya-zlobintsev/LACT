...
performance-level-profile-min-sclk-description = Profil Modus welcher die GPU auf niedrigste Stufe zwingt
performance-level-profile-min-mclk-description = Profil welches das VRAM auf niedrigste Stufe zwingt
performance-level-profile-peak-description = Profil welches GPU und VRAM auf höchste Stufe zwingt
