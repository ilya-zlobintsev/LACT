...
stat-clockspeed = Clockspeed
stat-fan-rpm = Fan RPM
stat-fan = Fan
stat-power-draw = Power Draw
stat-power-draw-avg = Power Draw (Avg)
stat-vram-size = VRAM Size
stat-gtt-size = GTT Size
no-throttling = No
