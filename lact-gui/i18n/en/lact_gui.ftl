...
performance-level-auto-description = Clocks scale dynamically
performance-level-high-description = Forces the highest performance state
performance-level-low-description = Forces the lowest performance state
performance-level-manual-description = Manually set clock states and limits
performance-level-profile-standard-description = Fixed mid-range clocks, no clock/power gating
performance-level-profile-min-sclk-description = Lowest GPU clock, no clock/power gating
performance-level-profile-min-mclk-description = Lowest memory clock, no clock/power gating
performance-level-profile-peak-description = Highest clocks, no clock/power gating
...
power-mizer-mode-auto-description = Driver picks the policy
power-mizer-mode-adaptive-description = Clocks scale with GPU utilization
power-mizer-mode-prefer-maximum-performance-description = Favors maximum performance
power-mizer-mode-prefer-consistent-performance-description = Locks to base clocks, no boost
