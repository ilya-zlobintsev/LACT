...
exit = Изађи
confirm = Потврди
confirm-settings = Потврди подешавања
...
close = Затвори
menu = Мени
displays-page = Подаци екрана
display-title = Екран { $identifier }
display-manufacturer = Произвођач
display-product-code = Шифра производа
display-model = Модел
